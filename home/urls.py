...
from .views.pages import home, productos, industrias, nosotros, contacto, categoria, producto_detalle
...
urlpatterns = [
    ...
    path("productos/<slug:slug>/", categoria, name="categoria"),
    path("producto/<slug:slug>/", producto_detalle, name="producto_detalle"),
